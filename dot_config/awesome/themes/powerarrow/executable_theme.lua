...
theme.wallpaper                                 = os.getenv("HOME") .. "/.local/share/wallpapers/Shiny-Nebula Wallpaper With Plasma Logo.jpg"
...
theme.bg_focus                                  = "#30323F"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#282a36"
theme.taglist_bg_focus							= "#9466B2"
theme.tasklist_bg_focus                         = "#30323F"
theme.tasklist_fg_focus                         = "#A77AC4"
theme.border_width                              = dpi(2)
theme.border_normal                             = "#282a36"
theme.border_focus                              = "#B181D0"
